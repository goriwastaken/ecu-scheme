...
/**
 * @brief Computes the masses m(p) of all vertices of the mesh in the linear FE
 * space case
...
/**
 * @brief Computes the masses m(p) of all vertices of the mesh in the quadratic
 * FE space case
 * @param mesh_p pointer to the mesh
 * @return Data structure containing the masses m(p) for all vertices of the
 * mesh represented by mesh_p.
...
/**
 * @brief Computes the masses m(p) of all midpoints of edges of the mesh in the
 * quadratic FE space case
 * @param mesh_p pointer to the mesh
 * @return Data structure containing the masses m(p) for all midpoints of edges
 * of the mesh represented by mesh_p.
 */
